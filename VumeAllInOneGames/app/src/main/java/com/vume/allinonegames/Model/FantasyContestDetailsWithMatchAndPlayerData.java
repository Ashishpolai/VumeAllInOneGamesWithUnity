...
public class FantasyContestDetailsWithMatchAndPlayerData {
    ...
    public FantasyContestDetailsWithMatchAndPlayerData(int mMaxTeams, List<FantasyprizesData> mPrizesList, int mIsPrivate,
